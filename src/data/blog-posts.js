...
export const SEED_POSTS = [
  {
    ...
    body: `Salvium is hard forking to activate on-chain token creation. Here's what's shipping, how it works, and what you need to do.
